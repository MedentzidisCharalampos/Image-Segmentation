...
#Image augumentation of flipping an image
@tf.function
...
#The dataset is splited into train and test
...
#An image example and the corresponding mask
...
#Three channels because there are three posible labels for each pixel
OUTPUT_CHANNELS = 3
...
#Prediction of the model before training
